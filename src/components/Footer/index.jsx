                ...
                <div className="row">
                    ...
                    <div className="col-md-3">
                        ...
                        <div className="d-flex mb-3">
                            ...
                            <a href="https://instagram.com/yusr0nab" target="_blank"><i className="bi bi-instagram"></i></a>
                            <a href="https://twitter.com" target="_blank"><i className="bi bi-twitter"></i></a>
                            <a href="https://mail.google.com" target="_blank"><i className="bi bi-envelope"></i></a>
                            <a href="https://twitch.com" target="_blank"><i className="bi bi-twitch"></i></a>
                        </div>
                    </div>
